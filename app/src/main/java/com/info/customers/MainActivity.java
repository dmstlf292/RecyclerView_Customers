...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.addItem(new Customer("김준수", "1995-10-20", "010-1000-1000", R.drawable.ic_launcher_foreground));
        adapter.addItem(new Customer("이희연", "1994-02-13", "010-2000-2000", R.drawable.ic_launcher_foreground));
        ...
        button.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                adapter.addItem(new Customer(name, birth, mobile, R.drawable.ic_launcher_foreground));
